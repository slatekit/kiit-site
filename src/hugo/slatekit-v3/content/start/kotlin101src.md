...
<table id="overview" class="table table-striped table-bordered">
  <tbody>
    ...
    <tr>
      ...
      <td class=" text-center"><a href="#kotlin-vals" class="more"><span class="btn btn-primary">More</span></a></td>
    </tr>
    <tr>
...
<table id="overview" class="table table-striped table-bordered">
  <tbody>
    ...
    <tr>
      ...
      <td class=" text-center"><a href="#kotlin-nulls" class="more"><span class="btn btn-primary">More</span></a></td>
    </tr>
  </tbody>
</table>
<br/><br/>
...
<h1 id="kotlin_101_functions">4. Functions</h1>
...
<!--
<br/><br/>
<h1 id="lang_101_futures">8. More</h1>
<p>These are more specific features of the kotlin language</p>
<table class="table table-striped table-bordered">
  <tbody>
    <tr>
      <td class="col-md-2"><strong>value classes</strong></td>
      <td>strings that span multiple lines</td>
      <td class="col-md-2 text-center"><a href="#kotlin-types-values" class="more"><span class="btn btn-primary">More</span></a></td>
    </tr>
    <tr>
      <td><strong>type alias</strong></td>
      <td>how to create instances without using "new"</td>
      <td class=" text-center"><a href="#kotlin-types-alias" class="more"><span class="btn btn-primary">More</span></a></td>
    </tr>
    <tr>
      <td><strong>type parameters</strong></td>
      <td>create immutable values of different types</td>
      <td class=" text-center"><a href="#kotlin-types-params" class="more"><span class="btn btn-primary">More</span></a></td>
    </tr>
    <tr>
      <td><strong>type classes</strong></td>
      <td>how to work with nullable values using Option, Some, None</td>
      <td class=" text-center"><a href="#kotlin-types-classes" class="more"><span class="btn btn-primary">More</span></a></td>
    </tr>
    <tr>
      <td><strong>type bounds</strong></td>
      <td>strings that span multiple lines</td>
      <td class=" text-center"><a href="#kotlin-types-bounds" class="more"><span class="btn btn-primary">More</span></a></td>
    </tr>
    <tr>
      <td><strong>phantom types</strong></td>
      <td>passing a block of code to a function</td>
      <td class=" text-center"><a href="#kotlin-types-phantom" class="more"><span class="btn btn-primary">More</span></a></td>
    </tr>
  </tbody>
</table>
-->
...
<div class="highlighter-rouge"><pre class="highlight"><code>  
  ...
  <span class="kd">val</span> <span class="py">map1</span>      <span class="p">=</span> <span class="n">mapOf</span><span class="p">(</span><span class="s">"a"</span> <span class="n">to</span> <span class="m">1</span><span class="p">,</span> <span class="s">"b"</span> <span class="n">to</span> <span class="m">2</span><span class="p">)</span>
  ...
  <span class="kd">val</span> <span class="py">range3</span>   <span class="p">:</span> <span class="n">IntRange</span><span class="p">?</span>          <span class="p">=</span> <span class="m">1</span><span class="o">..</span><span class="m">4</span>
...
<div class="highlighter-rouge"><pre class="highlight"><code> 
  ...
  <span class="c1">// 7. Get all last one
</span>  
  ...
  <span class="c1">// 13. Remove an item at index 3
</span>  
  ...
  <span class="c1">// 17. Finally, combine 2 lists together
</span>  
...
<div class="highlighter-rouge"><pre class="highlight"><code>
  ...
  <span class="c1">// 8. Add multiple items</span>  
...
<div class="highlighter-rouge"><pre class="highlight"><code>  
  ...
  <span class="c1">// 2. Create a triple of string, bool, int</span>  
...
<div class="highlighter-rouge"><pre class="highlight"><code>
  ...
  <span class="k">fun</span> <span class="nf">testNullsWithBasicType</span><span class="p">():</span><span class="n">Unit</span> <span class="p">{</span>
      ...
      <span class="c1">// 1. Smart conditions</span>      
...
<h2 id="kotlin-conditions">Conditions</h2>
...
<div class="highlighter-rouge"><pre class="highlight"><code>
    <span class="k">fun</span> <span class="nf">testWhen</span><span class="p">(</span><span class="n">item</span><span class="p">:</span> <span class="n">Any</span><span class="p">):</span> <span class="n">Unit</span> <span class="p">{</span>
        ...
        <span class="k">when</span> <span class="p">(</span><span class="n">item</span><span class="p">)</span> <span class="p">{</span>
            ...
            <span class="c1">// 3. data type match
</span>            
    ...
    <span class="n">testWhen</span><span class="p">(</span><span class="k">false</span><span class="p">)</span>
...
<div class="highlighter-rouge"><pre class="highlight"><code>  
      ...
      <span class="c1">// Now print the result ( tuple )</span>  
...
<div class="highlighter-rouge"><pre class="highlight"><code>  
  ...
  <span class="c1">// Case 1: apply function to each</span>
...
<div class="highlighter-rouge"><pre class="highlight"><code>
  ...
  <span class="c1">// NOTE: Single line function body can be written using an "=" sign</span>  
  <span class="k">fun</span> <span class="nf">salary</span><span class="p">(</span><span class="n">rate</span><span class="p">:</span><span class="n">Double</span><span class="p">,</span> <span class="n">hours</span><span class="p">:</span><span class="n">Int</span><span class="p">):</span><span class="n">Double</span> <span class="p">=</span> <span class="n">rate</span> <span class="p">*</span> <span class="n">hours</span>
  
  
  <span class="c1">// Test the functions</span> 
  <span class="k">fun</span> <span class="nf">test</span><span class="p">():</span> <span class="n">Unit</span> <span class="p">{</span>
  
      <span class="c1">// function with parameters</span>      
      <span class="n">salary</span><span class="p">(</span><span class="m">10.50</span><span class="p">,</span> <span class="m">8</span><span class="p">)</span>
  <span class="p">}</span>
...
<h2 id="kotlin-functions-named">Named Parameters</h2>
<p>Function calls with named parameters</p>
<div class="highlighter-rouge"><pre class="highlight"><code>
  <span class="c1">// Sample function to calculate a salary.</span>  
  <span class="c1">// NOTE: Single line function body can be written using an "=" sign</span>  
  <span class="k">fun</span> <span class="nf">salary</span><span class="p">(</span><span class="n">rate</span><span class="p">:</span><span class="n">Double</span><span class="p">,</span> <span class="n">hours</span><span class="p">:</span><span class="n">Int</span><span class="p">):</span><span class="n">Double</span> <span class="p">=</span> <span class="n">rate</span> <span class="p">*</span> <span class="n">hours</span>
  ...
  <span class="k">fun</span> <span class="nf">test</span><span class="p">():</span> <span class="n">Unit</span> <span class="p">{</span>
      ...
      <span class="c1">// call with named parameters</span>      
      <span class="n">salary</span><span class="p">(</span><span class="n">rate</span> <span class="p">=</span> <span class="m">10.50</span><span class="p">,</span> <span class="n">hours</span> <span class="p">=</span> <span class="m">8</span> <span class="p">)</span>
  <span class="p">}</span>
...
<h2 id="kotlin-functions-default">Default Parameter Value</h2>
<p>Supplying default function parameter values</p>
<div class="highlighter-rouge"><pre class="highlight"><code>
  <span class="c1">// Sample function to create a user.</span>
  <span class="c1">// NOTES:</span>
  <span class="c1">// 1. Parameters can have default values</span>
  <span class="c1">// 2. Unit is a type that does not represent any value</span>
  <span class="k">fun</span> <span class="nf">createUser</span><span class="p">(</span><span class="n">name</span><span class="p">:</span> <span class="n">String</span><span class="p">,</span> <span class="n">isActive</span><span class="p">:</span> <span class="n">Boolean</span> <span class="p">=</span> <span class="k">true</span><span class="p">):</span> <span class="n">Unit</span> <span class="p">{</span>
  ...
  <span class="k">fun</span> <span class="nf">test</span><span class="p">():</span> <span class="n">Unit</span> <span class="p">{</span>
      ...
      <span class="c1">// function with parameters with default values</span>      
      <span class="n">createUser</span><span class="p">(</span><span class="s">"john doe"</span><span class="p">)</span>
  <span class="p">}</span>
...
<h2 id="kotlin-functions-hof-passing">HOF: Passing a function</h2>
<p>One type of Higher Order Functions ( HOF ) is a function that is passed as a parameter to another function</p>
<div class="highlighter-rouge"><pre class="highlight"><code>
   <span class="c1">// Sample function to simulate creating a new user with a callback
</span>   <span class="c1">// function supplied. This function takes 1 parameter of type Int
</span>   <span class="c1">// and returns nothing ( Unit ).
</span>   <span class="k">fun</span> <span class="nf">createUser</span><span class="p">(</span> <span class="n">name</span><span class="p">:</span><span class="n">String</span><span class="p">,</span> <span class="n">isActive</span><span class="p">:</span><span class="n">Boolean</span><span class="p">,</span> <span class="n">onComplete</span><span class="p">:(</span><span class="n">Int</span><span class="p">)</span> <span class="p">-&gt;</span> <span class="n">Unit</span><span class="p">)</span> <span class="p">:</span> <span class="n">Unit</span> <span class="p">{</span>
       
       <span class="n">println</span><span class="p">(</span><span class="n">name</span> <span class="p">+</span> <span class="s">", "</span> <span class="p">+</span> <span class="n">isActive</span><span class="p">)</span>
       
       <span class="c1">// simulate saving to database....
</span>       <span class="kd">val</span> <span class="py">id</span> <span class="p">=</span> <span class="m">2</span>
       
       <span class="c1">// notify caller
</span>       <span class="n">onComplete</span><span class="p">(</span> <span class="n">id</span> <span class="p">)</span>
   <span class="p">}</span>
  
  
  <span class="c1">// Test the functions
</span>  <span class="k">fun</span> <span class="nf">test</span><span class="p">():</span> <span class="n">Unit</span> <span class="p">{</span>
      
      <span class="c1">// function with function parameter
</span>      <span class="n">createUser</span><span class="p">(</span><span class="s">"john doe"</span><span class="p">,</span> <span class="k">true</span><span class="p">,</span> <span class="p">{</span> <span class="n">id</span> <span class="p">-&gt;</span> <span class="n">println</span><span class="p">(</span><span class="s">"created with id : $id"</span><span class="p">)</span> <span class="p">}</span> <span class="p">)</span>
  <span class="p">}</span>
...
<h2 id="kotlin-functions-hof-return">HOF: Returning a function</h2>
<p>Another type of Higher Order Functions ( HOF ) is a function that is returned from another function</p>
<div class="highlighter-rouge"><pre class="highlight"><code>  <span class="c1">// Return a function that uses the rate per hour, and
</span>  <span class="c1">// overtime rate per hour to determine the salary.
</span>  <span class="c1">// This function only needs 1 parameter representing the hours worked
</span>  <span class="k">fun</span> <span class="nf">getSalaryCalculator</span><span class="p">(</span><span class="n">rate</span><span class="p">:</span> <span class="n">Double</span><span class="p">,</span> <span class="n">overtimeRate</span><span class="p">:</span> <span class="n">Double</span><span class="p">):</span> <span class="p">(</span><span class="n">Int</span><span class="p">)</span> <span class="p">-&gt;</span> <span class="n">Double</span> <span class="p">{</span>
      
      <span class="c1">// NOTE: As an analogy, you have basically "dependency injected"
</span>      <span class="c1">// the salary and overtimePay into the function you are returning.
</span>      <span class="kd">val</span> <span class="py">f</span> <span class="p">=</span> <span class="p">{</span> <span class="n">hours</span><span class="p">:</span> <span class="n">Int</span> <span class="p">-&gt;</span>            
          <span class="k">if</span> <span class="p">(</span><span class="n">hours</span> <span class="p">&lt;=</span> <span class="m">8</span><span class="p">)</span>
              <span class="n">rate</span> <span class="p">*</span> <span class="n">hours</span>
          <span class="k">else</span>
              <span class="n">rate</span> <span class="p">*</span> <span class="m">8</span> <span class="p">+</span> <span class="p">(</span><span class="n">overtimeRate</span> <span class="p">*</span> <span class="p">(</span><span class="n">hours</span> <span class="p">-</span> <span class="m">8</span><span class="p">))</span>
      <span class="p">}</span>
  ...
  <span class="c1">// Test the functions
      ...
      <span class="c1">// Supply the initial inputs ( rate per hour, rate overtime per hour )
</span>      <span class="kd">val</span> <span class="py">calc</span> <span class="p">=</span> <span class="n">getSalaryCalculator</span><span class="p">(</span><span class="m">10.0</span><span class="p">,</span> <span class="m">15.0</span><span class="p">)</span>

      <span class="c1">// Now you have a function that only requires the hours worked</span>      
      <span class="c1">// e.g. 140.00 = 8hours * 10.0 + 4hours * 15.0</span>      
      <span class="kd">val</span> <span class="py">pay</span> <span class="p">=</span> <span class="n">calc</span><span class="p">(</span><span class="m">12</span><span class="p">)</span>
      <span class="n">println</span><span class="p">(</span><span class="n">pay</span><span class="p">)</span>
  <span class="p">}</span>
</code></pre>
</div>
<a href="#overview" class="more"><span class="btn btn-template">Back to top</span></a> <br/><br/>
...
<h2 id="kotlin-functions-hof-compose">HOF: Function composition</h2>
<p>Functions can be composed, allowing 1 function to be the composite of 2 functions.</p>
<div class="highlighter-rouge"><pre class="highlight"><code>
  <span class="c1">// Simple utility function to "compose" 2 functions
</span>  <span class="c1">// into a new function that calls both.
</span>  <span class="k">fun</span> <span class="p">&lt;</span><span class="nf">A</span><span class="p">,</span> <span class="n">B</span><span class="p">&gt;</span> <span class="n">compose</span><span class="p">(</span><span class="n">f</span><span class="p">:</span> <span class="p">(</span><span class="n">A</span><span class="p">)</span> <span class="p">-&gt;</span> <span class="n">A</span><span class="p">,</span>
                     <span class="n">g</span><span class="p">:</span> <span class="p">(</span><span class="n">A</span><span class="p">)</span> <span class="p">-&gt;</span> <span class="n">B</span><span class="p">):</span> <span class="p">(</span><span class="n">A</span><span class="p">)</span> <span class="p">-&gt;</span> <span class="n">B</span> <span class="p">=</span> <span class="p">{</span> <span class="n">x</span> <span class="p">-&gt;</span> <span class="n">g</span><span class="p">(</span><span class="n">f</span><span class="p">(</span><span class="n">x</span><span class="p">))</span> <span class="p">}</span>
  
  
  <span class="k">fun</span> <span class="nf">composition</span><span class="p">():</span> <span class="n">Unit</span> <span class="p">{</span>
      
      <span class="c1">// 1st function to generate html for h1
</span>      <span class="kd">val</span> <span class="py">h1</span> <span class="p">=</span> <span class="p">{</span> <span class="n">text</span><span class="p">:</span> <span class="n">String</span> <span class="p">-&gt;</span> <span class="s">"&lt;h1&gt;"</span> <span class="p">+</span> <span class="n">text</span> <span class="p">+</span> <span class="s">"&lt;/h1&gt;"</span> <span class="p">}</span>
      
      <span class="c1">// 2nd function to generate html section
</span>      <span class="kd">val</span> <span class="py">section</span> <span class="p">=</span> <span class="p">{</span> <span class="n">content</span><span class="p">:</span> <span class="n">String</span> <span class="p">-&gt;</span> <span class="s">"&lt;div class='section'&gt;"</span> <span class="p">+</span> <span class="n">content</span> <span class="p">+</span> <span class="s">"&lt;/div&gt;"</span> <span class="p">}</span>
      
      <span class="c1">// Now lets combine section and h1
</span>      <span class="kd">val</span> <span class="py">heading</span> <span class="p">=</span> <span class="n">compose</span><span class="p">(</span> <span class="n">h1</span><span class="p">,</span> <span class="n">section</span> <span class="p">)</span>
      
      <span class="c1">// Generate the heading html
</span>      <span class="kd">val</span> <span class="py">html</span> <span class="p">=</span> <span class="n">heading</span><span class="p">(</span><span class="s">"Welcome"</span><span class="p">)</span>
      
      <span class="c1">// e.g. &lt;div class="section"&gt;&lt;h1&gt;Welcome&lt;/h1&gt;&lt;/div&gt;"
</span>      <span class="n">println</span><span class="p">(</span><span class="n">html</span><span class="p">)</span>
  <span class="p">}</span>

</code></pre>
</div>
<div class="alert alert-info" role="alert">
	<p><i class="fa fa-info-circle"></i> Function composition is one of the fundamental concepts in functional programming, and leads to other more sophisticated concepts such as currying.</p>
	
</div>
<a href="#overview" class="more"><span class="btn btn-template">Back to top</span></a> <br/><br/>

<h2 id="kotlin-functions-syntax">HOF: Syntax</h2>
<p>When the last parameter to a function is a function itself, it allows interesting approaches
to the syntax of the calls.</p>
<div class="highlighter-rouge"><pre class="highlight"><code>  
  <span class="cm">/**
   ...
   * @param callback
   */</span>
  <span class="k">fun</span> <span class="nf">REFACTOR</span><span class="p">(</span><span class="n">tag</span><span class="p">:</span> <span class="n">String</span> <span class="p">=</span> <span class="s">""</span><span class="p">,</span> <span class="n">msg</span><span class="p">:</span> <span class="n">String</span> <span class="p">=</span> <span class="s">""</span><span class="p">,</span> <span class="n">callback</span><span class="p">:</span> <span class="p">(()</span> <span class="p">-&gt;</span> <span class="n">Unit</span><span class="p">)?</span> <span class="p">=</span> <span class="k">null</span><span class="p">)</span> <span class="p">{</span>
      <span class="c1">// log to console or file
</span>  <span class="p">}</span>
	
	
  <span class="n">REFACTOR</span><span class="p">(</span><span class="s">"ACCOUNTS"</span><span class="p">,</span> <span class="s">"Improve error handling"</span><span class="p">,</span> <span class="p">{</span>
      <span class="c1">// Some code to cleanup here.
</span>  <span class="p">})</span>
  
  
  <span class="c1">// With parameters inside (...) first, then followed by code block { }
</span>  <span class="n">REFACTOR</span><span class="p">(</span><span class="s">"ACCOUNTS"</span><span class="p">,</span> <span class="s">"Improve error handling"</span><span class="p">)</span> <span class="p">{</span>
      <span class="c1">// Some code to cleanup here
</span>  <span class="p">}</span>
  
  <span class="c1">// With default params( "" empty strings), then followed by code block { }
</span>  <span class="n">REFACTOR</span> <span class="p">{</span>
      <span class="c1">// Some code to cleanup here
</span>  <span class="p">}</span>

  <span class="c1">// With defaults and no code block
</span>  <span class="n">REFACTOR</span><span class="p">()</span>

</code></pre>
</div>
<div class="alert alert-info" role="alert">
	<p><i class="fa fa-info-circle"></i> This provides a way to simulate custom control structures.</p>
</div>
<a href="#overview" class="more"><span class="btn btn-template">Back to top</span></a> <br/><br/>
...
<h1>5. Classes</h1>
<hr/>
<h2 id="kotlin-classes-basics">Classes</h2>
<p>Some basics of classes and constructors. This is a partial list of features</p>
<div class="highlighter-rouge"><pre class="highlight"><code>
  <span class="c1">// 1. You can declare class members in the constructor
</span>  <span class="c1">// 2. You can declare and set the access modifiers ( none = public, protected, private )
</span>  <span class="c1">// 3. You can declare whether they are mutable ( var ) or immutable ( val )
</span>  <span class="k">open</span> <span class="kd">class</span> <span class="nc">User</span><span class="p">(</span><span class="kd">val</span> <span class="py">name</span><span class="p">:</span> <span class="n">String</span><span class="p">,</span>
                  <span class="kd">var</span> <span class="py">isActive</span><span class="p">:</span> <span class="n">Boolean</span><span class="p">,</span>
                  <span class="k">protected</span> <span class="kd">val</span> <span class="py">email</span><span class="p">:</span> <span class="n">String</span><span class="p">,</span>
                  <span class="k">private</span> <span class="kd">val</span> <span class="py">account</span><span class="p">:</span> <span class="n">Int</span>
  
  <span class="p">)</span> <span class="p">{</span>
      <span class="n">init</span> <span class="p">{</span>
          <span class="c1">// initialization after primary constructor.
</span>          <span class="n">println</span><span class="p">(</span><span class="s">"instantiated with : "</span> <span class="p">+</span> <span class="n">name</span><span class="p">)</span>
      <span class="p">}</span>
  
  
      <span class="c1">// Overloaded constructors must call the primary constructor first
</span>      <span class="k">constructor</span><span class="p">()</span> <span class="p">:</span> <span class="k">this</span><span class="p">(</span><span class="s">""</span><span class="p">,</span> <span class="k">false</span><span class="p">,</span> <span class="s">""</span><span class="p">,</span> <span class="m">0</span><span class="p">)</span>
  
  
      <span class="c1">// Overloaded constructors must call the primary constructor first
</span>      <span class="k">constructor</span><span class="p">(</span><span class="n">name</span><span class="p">:</span> <span class="n">String</span><span class="p">)</span> <span class="p">:</span> <span class="k">this</span><span class="p">(</span><span class="n">name</span><span class="p">,</span> <span class="k">false</span><span class="p">,</span> <span class="s">""</span><span class="p">,</span> <span class="m">0</span><span class="p">)</span>
  
  
      <span class="k">fun</span> <span class="nf">printInfo</span><span class="p">():</span> <span class="n">Unit</span> <span class="p">{</span>
  
          <span class="n">println</span><span class="p">(</span><span class="s">"$name, $email, $account, $isActive"</span><span class="p">)</span>
      <span class="p">}</span>
  <span class="p">}</span>
</code></pre>
</div>
...
<h2 id="kotlin-classes-access">Access control</h2>
<p>Access modifiers are similar to other languages, with the convenience
of specifying the access level right at the constructor level.</p>
<div class="highlighter-rouge"><pre class="highlight"><code>
  <span class="c1">// 1. kotlin members are public by default
</span>  <span class="c1">// 2. protected works similar to java 
</span>  <span class="c1">// 3. private works similar to java 
</span>  <span class="c1">// 4. By setting field to "val" you make it immutable
</span>  <span class="k">open</span> <span class="k">class</span> <span class="nc">User</span><span class="o">(</span> <span class="k">val</span> <span class="n">name</span><span class="k">:</span><span class="kt">String</span><span class="o">,</span> 
              <span class="k">val</span> <span class="n">isActive</span><span class="k">:</span><span class="kt">Boolean</span><span class="o">,</span> 
              <span class="k">protected</span> <span class="k">val</span> <span class="n">account</span><span class="k">:</span><span class="kt">String</span><span class="o">,</span> 
              <span class="k">private</span> <span class="k">val</span> <span class="n">ssn</span><span class="k">:</span><span class="kt">String</span> <span class="o">)</span>
  <span class="o">{</span>
  <span class="o">}</span>
  
  <span class="k">val</span> <span class="n">p</span> <span class="k">=</span> <span class="nc">Person</span><span class="o">(</span><span class="s">"kishore"</span><span class="o">,</span> <span class="kc">true</span><span class="o">,</span> <span class="s">"abc"</span><span class="o">,</span> <span class="s">"123"</span><span class="o">)</span>

  <span class="c1">// Accessible
</span>  <span class="n">println</span><span class="o">(</span> <span class="n">p</span><span class="o">.</span><span class="n">name</span> <span class="o">)</span>
  <span class="n">println</span><span class="o">(</span> <span class="n">p</span><span class="o">.</span><span class="n">isActive</span> <span class="o">)</span>
  
  <span class="c1">// Unaccessible
</span>  <span class="c1">// println( p.account )
</span>  <span class="c1">// println( p.ssn )
...
<h2 id="kotlin-classes-subclassing">Inheritance</h2>
<p>Class inheritance and overriding methods</p>
<div class="highlighter-rouge"><pre class="highlight"><code>
  <span class="c1">// SUB-CLASSING:
</span>  <span class="c1">// 1. You must declare your class as "open" to sub-class it
</span>  <span class="c1">// 2. You must declare a method as "open" to override it
</span>  <span class="k">open</span> <span class="kd">class</span> <span class="nc">UserAccount</span><span class="p">(</span> <span class="kd">val</span> <span class="py">name</span><span class="p">:</span><span class="n">String</span><span class="p">,</span> <span class="kd">val</span> <span class="py">isActive</span><span class="p">:</span><span class="n">Boolean</span><span class="p">,</span> <span class="kd">val</span> <span class="py">roles</span><span class="p">:</span><span class="n">String</span> <span class="p">)</span>
  <span class="p">{</span>
      <span class="k">open</span> <span class="k">fun</span> <span class="nf">info</span><span class="p">():</span><span class="n">String</span> <span class="p">=</span> <span class="s">"USER: $name $isActive $roles"</span>
  <span class="p">}</span>
  
  
  <span class="c1">// Just a simple example showing how to extend a class.
</span>  <span class="kd">class</span> <span class="nc">AdminAccount</span><span class="p">(</span><span class="n">name</span><span class="p">:</span><span class="n">String</span><span class="p">)</span> <span class="p">:</span> <span class="n">UserAccount</span><span class="p">(</span><span class="n">name</span><span class="p">,</span> <span class="k">true</span><span class="p">,</span> <span class="s">"admin"</span><span class="p">)</span>
  <span class="p">{</span>
      <span class="k">override</span> <span class="k">fun</span> <span class="nf">info</span><span class="p">():</span><span class="n">String</span> <span class="p">=</span> <span class="s">"ADMIN: $name $isActive $roles"</span>
  <span class="p">}</span>
...
<h2 id="kotlin-classes-data">Data classes</h2>
<p>Case classes provide a convenient way to make all members of the class readonly/vals. Boiler-plate code such as copy methods are automatically created,
and they are used for pattern-matching.</p>
<div class="highlighter-rouge"><pre class="highlight"><code>
  <span class="c1">// Mark class with "data".
</span>  <span class="c1">// USE CASES:
</span>  <span class="c1">// 1. Data classes are useful when you typically want to just hold data
</span>  <span class="c1">// 2. They are also useful in pattern-matching.
</span>  <span class="c1">//
</span>  <span class="c1">// AUTOMATIC SUPPORT
</span>  <span class="c1">// Data classes have the "equals()", "toString()" and "copy(...)"
</span>  <span class="c1">// methods automatically created by the compiler.
</span>  <span class="kd">data class</span> <span class="nc">Role</span><span class="p">(</span><span class="kd">val</span> <span class="py">name</span><span class="p">:</span><span class="n">String</span><span class="p">,</span> <span class="kd">val</span> <span class="py">desc</span><span class="p">:</span><span class="n">String</span><span class="p">,</span> <span class="kd">val</span> <span class="py">features</span><span class="p">:</span><span class="n">List</span><span class="p">&lt;</span><span class="n">String</span><span class="p">&gt;)</span>
  
  
  <span class="k">fun</span> <span class="nf">testRoles</span><span class="p">():</span><span class="n">Unit</span> <span class="p">{</span>
  
      <span class="c1">// Create role with name, desc, and feature list
</span>      <span class="kd">val</span> <span class="py">role1</span> <span class="p">=</span> <span class="n">Role</span><span class="p">(</span><span class="s">"editors"</span><span class="p">,</span> <span class="s">"Create / Edit content"</span><span class="p">,</span> <span class="n">listOf</span><span class="p">(</span><span class="s">"blogs"</span><span class="p">,</span> <span class="s">"comments"</span><span class="p">))</span>
      <span class="n">println</span><span class="p">(</span><span class="n">role1</span><span class="p">)</span>
  
      <span class="c1">// Copy role1 with existing features but just change name and desc.
</span>      <span class="kd">val</span> <span class="py">role2</span> <span class="p">=</span> <span class="n">role1</span><span class="p">.</span><span class="n">copy</span><span class="p">(</span><span class="s">"moderators"</span><span class="p">,</span> <span class="s">"moderate content"</span><span class="p">)</span>
      <span class="n">println</span><span class="p">(</span><span class="n">role2</span><span class="p">)</span>
  <span class="p">}</span>
...
<h2 id="kotlin-classes-traits">Interfaces</h2>
<p>Interfaces/contracts with implementations</p>
<div class="highlighter-rouge"><pre class="highlight"><code>
  <span class="c1">// Interfaces can have implementations
</span>  <span class="kd">interface</span> <span class="nc">AccountSupport</span> <span class="p">{</span>
  
      <span class="k">fun</span> <span class="nf">activate</span><span class="p">():</span><span class="n">Unit</span> <span class="p">{</span>
          <span class="c1">// do some processing and notify
</span>          <span class="n">notify</span><span class="p">(</span><span class="s">"account activated"</span><span class="p">)</span>
      <span class="p">}</span>
  
  
      <span class="k">fun</span> <span class="nf">deactivate</span><span class="p">():</span><span class="n">Unit</span> <span class="p">{</span>
          <span class="c1">// do some processing and notify
</span>          <span class="n">notify</span><span class="p">(</span><span class="s">"account deactivated"</span><span class="p">)</span>
      <span class="p">}</span>
  
  
      <span class="k">fun</span> <span class="nf">notify</span><span class="p">(</span><span class="n">state</span><span class="p">:</span><span class="n">String</span><span class="p">):</span><span class="n">Unit</span> <span class="p">{</span>
          <span class="c1">// e.g. send to phone / log / audit etc.
</span>          <span class="c1">// just println for sample purposes
</span>          <span class="n">println</span><span class="p">(</span><span class="n">state</span><span class="p">)</span>
      <span class="p">}</span>
  <span class="p">}</span>
  
  
  <span class="c1">// Just a simple example showing how to extend a class.
</span>  <span class="kd">class</span> <span class="nc">ModeratorAccount</span><span class="p">(</span><span class="n">name</span><span class="p">:</span><span class="n">String</span><span class="p">)</span>
      <span class="p">:</span> <span class="n">UserAccount</span><span class="p">(</span><span class="n">name</span><span class="p">,</span> <span class="k">true</span><span class="p">,</span> <span class="s">"moderators"</span><span class="p">)</span>
      <span class="p">,</span> <span class="n">AccountSupport</span>
  <span class="p">{</span>
      <span class="k">override</span> <span class="k">fun</span> <span class="nf">info</span><span class="p">():</span><span class="n">String</span> <span class="p">=</span> <span class="s">"MOD: $name $isActive $roles"</span>
  <span class="p">}</span>
  
  
  <span class="k">fun</span> <span class="nf">testInterfaces</span><span class="p">():</span><span class="n">Unit</span> <span class="p">{</span>
      <span class="kd">val</span> <span class="py">mod</span> <span class="p">=</span> <span class="n">ModeratorAccount</span><span class="p">(</span><span class="s">"john"</span><span class="p">)</span>
      <span class="n">mod</span><span class="p">.</span><span class="n">activate</span><span class="p">()</span>
      <span class="n">mod</span><span class="p">.</span><span class="n">deactivate</span><span class="p">()</span>
  <span class="p">}</span>
...
<h2 id="kotlin-classes-static">Static methods</h2>
<p>kotlin does not have static methods. but you can declare the class as an <strong>object</strong> accessing it statically</p>

<div class="highlighter-rouge"><pre class="highlight"><code>
  <span class="c1">// You can put "static" methods on a class inside a companion object    
</span>  <span class="k">open</span> <span class="kd">class</span> <span class="nc">UserAccount</span><span class="p">(</span> <span class="kd">val</span> <span class="py">name</span><span class="p">:</span><span class="n">String</span><span class="p">,</span> <span class="kd">val</span> <span class="py">isActive</span><span class="p">:</span><span class="n">Boolean</span><span class="p">,</span> <span class="kd">val</span> <span class="py">roles</span><span class="p">:</span><span class="n">String</span> <span class="p">)</span>
  <span class="p">{</span>
      <span class="k">open</span> <span class="k">fun</span> <span class="nf">info</span><span class="p">():</span><span class="n">String</span> <span class="p">=</span> <span class="s">"USER: $name $isActive $roles"</span>
   
  
      <span class="k">companion</span> <span class="kd">object</span> <span class="p">{
          <span class="kd">val</span> <span class="py">guest</span> <span class="p">=</span> <span class="n">UserAccount</span><span class="p">(</span><span class="s">"guest"</span><span class="p">,</span> <span class="k">false</span><span class="p">,</span> <span class="s">""</span><span class="p">)</span>
      <span class="p">}</span>
  <span class="p">}</span>
  
  
  <span class="c1">// This is essentially a singleton class
</span>  <span class="kd">object</span> <span class="nc">Accounts</span> <span class="p">{</span>
      <span class="c1">// This is essentially a static member.
</span>      <span class="kd">val</span> <span class="py">guest</span> <span class="p">=</span> <span class="n">UserAccount</span><span class="p">(</span><span class="s">"guest"</span><span class="p">,</span> <span class="k">false</span><span class="p">,</span> <span class="s">""</span><span class="p">)</span>
  <span class="p">}</span>
  
  
  <span class="k">fun</span> <span class="nf">testStatic</span><span class="p">():</span><span class="n">Unit</span> <span class="p">{</span>
      <span class="kd">val</span> <span class="py">guestFromCompanion</span> <span class="p">=</span> <span class="n">UserAccount</span><span class="p">.</span><span class="n">guest</span>
      <span class="kd">val</span> <span class="py">guestFromExternalCls</span> <span class="p">=</span> <span class="n">Accounts</span><span class="p">.</span><span class="n">guest</span>
  <span class="p">}</span>
...
<h1>6. Misc</h1>
<hr/>
<h2 id="kotlin-extensions">Extensions</h2>
<p>Extension methods to add functionality to types</p>
<div class="highlighter-rouge"><pre class="highlight"><code>
  <span class="cm">/**
   * Truncate the string to the length supplied
   */</span>
  <span class="k">fun</span> <span class="nf">String</span><span class="p">.</span><span class="n">truncate</span><span class="p">(</span><span class="n">len</span><span class="p">:</span><span class="n">Int</span><span class="p">):</span><span class="n">String</span> <span class="p">=</span>
      <span class="k">if</span><span class="p">(</span><span class="k">this</span><span class="p">.</span><span class="n">length</span> <span class="p">&gt;</span> <span class="n">len</span><span class="p">)</span>
          <span class="k">this</span><span class="p">.</span><span class="n">substring</span><span class="p">(</span><span class="m">0</span><span class="p">,</span> <span class="n">len</span><span class="p">)</span>
      <span class="k">else</span>
   ...
   */</span>
  <span class="k">fun</span> <span class="p">&lt;</span><span class="nf">T</span><span class="p">&gt;</span> <span class="n">List</span><span class="p">&lt;</span><span class="n">T</span><span class="p">&gt;.</span><span class="n">tail</span><span class="p">():</span> <span class="n">List</span><span class="p">&lt;</span><span class="n">T</span><span class="p">&gt;</span> <span class="p">=</span> <span class="k">this</span><span class="p">.</span><span class="n">drop</span><span class="p">(</span><span class="m">1</span><span class="p">)</span>
  
  
  <span class="k">fun</span> <span class="nf">testExtensions</span><span class="p">():</span><span class="n">Unit</span> <span class="p">{</span>
      <span class="c1">// Prints "abc!"
</span>      <span class="n">println</span><span class="p">(</span><span class="s">"abcd"</span><span class="p">.</span><span class="n">truncate</span><span class="p">(</span><span class="m">3</span><span class="p">)</span> <span class="p">+</span> <span class="s">"!"</span><span class="p">)</span>
  
      <span class="c1">// Prints ["b", "c"]
</span>      <span class="n">println</span><span class="p">(</span><span class="n">listOf</span><span class="p">(</span><span class="s">"a"</span><span class="p">,</span> <span class="s">"b"</span><span class="p">,</span> <span class="s">"c"</span><span class="p">).</span><span class="n">tail</span><span class="p">())</span>
  <span class="p">}</span>
...
<h2 id="kotlin-operators">Operators</h2>
<p>You can override multiple operators such as <strong>compareTo</strong> using the operation keyword.
<div class="highlighter-rouge"><pre class="highlight"><code>  <span class="cm">/**
   * @param start: 1
   * @param end  : 4
   */</span>
  <span class="kd">class</span> <span class="nc">MyRange</span><span class="p">(</span><span class="kd">val</span> <span class="py">start</span><span class="p">:</span><span class="n">Int</span><span class="p">,</span> <span class="kd">val</span> <span class="py">end</span><span class="p">:</span><span class="n">Int</span> <span class="p">){</span>
  
      <span class="c1">// Override inc ++
</span>      <span class="k">operator</span> <span class="k">fun</span> <span class="nf">inc</span><span class="p">():</span><span class="n">MyRange</span> <span class="p">=</span> <span class="n">MyRange</span><span class="p">(</span><span class="n">start</span><span class="p">,</span> <span class="n">end</span> <span class="p">+</span> <span class="m">1</span><span class="p">)</span>
  
  
      <span class="c1">// Override dec --
</span>      <span class="k">operator</span> <span class="k">fun</span> <span class="nf">dec</span><span class="p">():</span><span class="n">MyRange</span> <span class="p">=</span> <span class="n">MyRange</span><span class="p">(</span><span class="n">start</span><span class="p">,</span> <span class="n">end</span> <span class="p">-</span> <span class="m">1</span> <span class="p">)</span>
  
  
      <span class="c1">// Override plus +
</span>      <span class="k">operator</span> <span class="k">fun</span> <span class="nf">plus</span><span class="p">(</span><span class="n">num</span><span class="p">:</span><span class="n">Int</span><span class="p">):</span><span class="n">MyRange</span> <span class="p">=</span> <span class="n">MyRange</span><span class="p">(</span><span class="n">start</span><span class="p">,</span> <span class="n">end</span> <span class="p">+</span> <span class="n">num</span> <span class="p">)</span>
  
  
      <span class="c1">// Override minus - ( get the smallest range )
</span>      <span class="k">operator</span> <span class="k">fun</span> <span class="nf">minus</span><span class="p">(</span><span class="n">num</span><span class="p">:</span><span class="n">Int</span><span class="p">):</span><span class="n">MyRange</span> <span class="p">=</span> <span class="n">MyRange</span><span class="p">(</span><span class="n">start</span><span class="p">,</span> <span class="n">end</span> <span class="p">-</span> <span class="n">num</span> <span class="p">)</span>
  
  
      <span class="c1">// Override times *
</span>      <span class="k">operator</span> <span class="k">fun</span> <span class="nf">times</span><span class="p">(</span><span class="n">num</span><span class="p">:</span><span class="n">Int</span><span class="p">):</span><span class="n">MyRange</span> <span class="p">=</span> <span class="n">MyRange</span><span class="p">(</span><span class="n">start</span><span class="p">,</span> <span class="n">end</span> <span class="p">*</span> <span class="n">num</span> <span class="p">)</span>
  
  
      <span class="c1">// Override div Point * Point
</span>      <span class="k">operator</span> <span class="k">fun</span> <span class="nf">div</span><span class="p">(</span><span class="n">num</span><span class="p">:</span><span class="n">Int</span><span class="p">):</span><span class="n">MyRange</span> <span class="p">=</span> <span class="n">MyRange</span><span class="p">(</span><span class="n">start</span><span class="p">,</span> <span class="n">end</span> <span class="p">/</span> <span class="n">num</span> <span class="p">)</span>
  
  
      <span class="c1">// Override "in" 3 in myRange
</span>      <span class="k">operator</span> <span class="k">fun</span> <span class="nf">contains</span><span class="p">(</span><span class="n">x</span><span class="p">:</span><span class="n">Int</span><span class="p">):</span><span class="n">Boolean</span> <span class="p">=</span> <span class="n">x</span> <span class="k">in</span> <span class="n">start</span><span class="o">..</span><span class="n">end</span>
  
  
      <span class="c1">// Override index access [x] = true | false
</span>      <span class="k">operator</span> <span class="k">fun</span> <span class="nf">get</span><span class="p">(</span><span class="n">x</span><span class="p">:</span><span class="n">Int</span><span class="p">):</span><span class="n">Boolean</span> <span class="p">=</span> <span class="n">contains</span><span class="p">(</span><span class="n">x</span><span class="p">)</span>
  
  
      <span class="c1">// Override compare to ( &lt;, &lt;=, &gt;, &gt;=, ==, != )
</span>      <span class="k">operator</span> <span class="k">fun</span> <span class="nf">compareTo</span><span class="p">(</span><span class="n">other</span><span class="p">:</span><span class="n">MyRange</span><span class="p">):</span><span class="n">Int</span> <span class="p">{</span>
          <span class="kd">val</span> <span class="py">xCompare</span> <span class="p">=</span> <span class="n">start</span><span class="p">.</span><span class="n">compareTo</span><span class="p">(</span><span class="n">other</span><span class="p">.</span><span class="n">start</span><span class="p">)</span>
          <span class="k">if</span> <span class="p">(</span><span class="n">xCompare</span> <span class="p">!=</span> <span class="m">0</span><span class="p">)</span> <span class="k">return</span> <span class="n">xCompare</span>
          <span class="k">return</span> <span class="n">end</span><span class="p">.</span><span class="n">compareTo</span><span class="p">(</span><span class="n">other</span><span class="p">.</span><span class="n">end</span><span class="p">)</span>
      <span class="p">}</span>
  ...
  <span class="k">fun</span> <span class="nf">testOperator</span><span class="p">():</span><span class="n">Unit</span> <span class="p">{</span>
  
      <span class="c1">// Test ++, --
</span>      <span class="kd">var</span> <span class="py">r1</span> <span class="p">=</span> <span class="n">MyRange</span><span class="p">(</span><span class="m">1</span><span class="p">,</span><span class="m">4</span><span class="p">)</span>
      <span class="n">println</span><span class="p">(</span> <span class="n">r1</span><span class="p">++</span> <span class="p">)</span>
      <span class="n">println</span><span class="p">(</span> <span class="n">r1</span><span class="p">--</span> <span class="p">)</span>
  
      <span class="c1">// Test +, -, *, /
</span>      <span class="n">println</span><span class="p">(</span> <span class="n">r1</span> <span class="p">+</span> <span class="m">2</span> <span class="p">)</span>
      <span class="n">println</span><span class="p">(</span> <span class="n">r1</span> <span class="p">-</span> <span class="m">2</span> <span class="p">)</span>
      <span class="n">println</span><span class="p">(</span> <span class="n">r1</span> <span class="p">*</span> <span class="m">2</span> <span class="p">)</span>
      <span class="n">println</span><span class="p">(</span> <span class="n">r1</span> <span class="p">/</span> <span class="m">2</span> <span class="p">)</span>
  
      <span class="c1">// Test in/contains
</span>      <span class="n">println</span><span class="p">(</span> <span class="m">3</span> <span class="k">in</span> <span class="n">r1</span> <span class="p">)</span>
      <span class="n">println</span><span class="p">(</span> <span class="m">10</span> <span class="k">in</span> <span class="n">r1</span> <span class="p">)</span>
  
      <span class="c1">// Test get
</span>      <span class="n">println</span><span class="p">(</span><span class="n">r1</span><span class="p">[</span><span class="m">3</span><span class="p">])</span>
      <span class="n">println</span><span class="p">(</span><span class="n">r1</span><span class="p">[</span><span class="m">10</span><span class="p">])</span>
  
      <span class="c1">// Test &lt;, &lt;=, &gt;, &gt;=
</span>      <span class="n">println</span><span class="p">(</span><span class="n">MyRange</span><span class="p">(</span><span class="m">1</span><span class="p">,</span> <span class="m">3</span><span class="p">)</span> <span class="p">&gt;</span>  <span class="n">MyRange</span><span class="p">(</span><span class="m">1</span><span class="p">,</span> <span class="m">2</span><span class="p">))</span>
      <span class="n">println</span><span class="p">(</span><span class="n">MyRange</span><span class="p">(</span><span class="m">1</span><span class="p">,</span> <span class="m">3</span><span class="p">)</span> <span class="p">&gt;=</span> <span class="n">MyRange</span><span class="p">(</span><span class="m">1</span><span class="p">,</span> <span class="m">2</span><span class="p">))</span>
      <span class="n">println</span><span class="p">(</span><span class="n">MyRange</span><span class="p">(</span><span class="m">1</span><span class="p">,</span> <span class="m">3</span><span class="p">)</span> <span class="p">&lt;</span>  <span class="n">MyRange</span><span class="p">(</span><span class="m">1</span><span class="p">,</span> <span class="m">4</span><span class="p">))</span>
      <span class="n">println</span><span class="p">(</span><span class="n">MyRange</span><span class="p">(</span><span class="m">1</span><span class="p">,</span> <span class="m">3</span><span class="p">)</span> <span class="p">&lt;=</span> <span class="n">MyRange</span><span class="p">(</span><span class="m">1</span><span class="p">,</span> <span class="m">4</span><span class="p">))</span>
  <span class="p">}</span>
...
<h2 id="kotlin-type-alias">Type Alias</h2>
<p>Create an alias for types</p>
<div class="highlighter-rouge"><pre class="highlight"><code>
  <span class="c1">// The type alias here becomes the shorthand for the function signature
</span>  <span class="k">typealias</span> <span class="n">ErrorHandler</span> <span class="p">=</span> <span class="p">(</span><span class="n">Int</span><span class="p">,</span> <span class="n">String</span><span class="p">,</span> <span class="n">Exception</span><span class="p">)</span> <span class="p">-&gt;</span> <span class="n">Unit</span>
  
  
  <span class="k">fun</span> <span class="nf">onError</span><span class="p">(</span><span class="n">code</span><span class="p">:</span><span class="n">Int</span><span class="p">,</span> <span class="n">msg</span><span class="p">:</span><span class="n">String</span><span class="p">,</span> <span class="n">ex</span><span class="p">:</span><span class="n">Exception</span><span class="p">):</span><span class="n">Unit</span> <span class="p">{</span>
     <span class="n">println</span><span class="p">(</span><span class="s">"$code $msg ${ex.message}"</span><span class="p">)</span>
  <span class="p">}</span>
  
  
  <span class="c1">// onError callback explicitly defined with function signature
</span>  <span class="k">fun</span> <span class="nf">createUser1</span><span class="p">(</span><span class="n">email</span><span class="p">:</span><span class="n">String</span><span class="p">,</span> <span class="n">onError</span><span class="p">:(</span><span class="n">Int</span><span class="p">,</span> <span class="n">String</span><span class="p">,</span> <span class="n">Exception</span><span class="p">)</span> <span class="p">-&gt;</span> <span class="n">Unit</span><span class="p">):</span><span class="n">Unit</span> <span class="p">{</span>
      <span class="k">try</span> <span class="p">{</span>
          <span class="c1">// create user here
</span>      <span class="p">}</span> <span class="k">catch</span> <span class="p">(</span><span class="n">ex</span><span class="p">:</span><span class="n">Exception</span><span class="p">)</span> <span class="p">{</span>
          <span class="n">onError</span><span class="p">(</span><span class="m">500</span><span class="p">,</span> <span class="s">"unexpected error creating user"</span><span class="p">,</span> <span class="n">ex</span> <span class="p">)</span>
      <span class="p">}</span>
  <span class="p">}</span>
  
  
  <span class="c1">// onError callback is shorter and cleaner using type alias
</span>  <span class="k">fun</span> <span class="nf">createUser2</span><span class="p">(</span><span class="n">email</span><span class="p">:</span><span class="n">String</span><span class="p">,</span> <span class="n">onError</span><span class="p">:</span><span class="n">ErrorHandler</span><span class="p">):</span><span class="n">Unit</span> <span class="p">{</span>
      <span class="k">try</span> <span class="p">{</span>
          <span class="c1">// create user here
</span>      <span class="p">}</span> <span class="k">catch</span> <span class="p">(</span><span class="n">ex</span><span class="p">:</span><span class="n">Exception</span><span class="p">)</span> <span class="p">{</span>
          <span class="n">onError</span><span class="p">(</span><span class="m">500</span><span class="p">,</span> <span class="s">"unexpected error creating user"</span><span class="p">,</span> <span class="n">ex</span> <span class="p">)</span>
  ...
  <span class="k">fun</span> <span class="nf">testTypeAlias</span><span class="p">():</span><span class="n">Unit</span> <span class="p">{</span>
      <span class="c1">// Same code at the call site
</span>      <span class="n">createUser1</span><span class="p">(</span><span class="s">"batman@gotham"</span><span class="p">,</span> <span class="o">::</span><span class="n">onError</span><span class="p">)</span>
      <span class="n">createUser2</span><span class="p">(</span><span class="s">"batman@gotham"</span><span class="p">,</span> <span class="o">::</span><span class="n">onError</span><span class="p">)</span>
  <span class="p">}</span>
</code></pre>
</div>
<a href="#overview" class="more"><span class="btn btn-template">Back to top</span></a> <br/><br/>
...
<h2 id="kotlin-todo">TODO</h2>
<p>Create an alias for types</p>
<div class="highlighter-rouge"><pre class="highlight"><code> 
  <span class="c1">// Here the TODO function from standard library returns "Nothing"
</span>  <span class="c1">// which allows the code to compile even though the function returns 
</span>  <span class="c1">// a type of Pair&lt;Int,String&gt;
</span>  <span class="k">fun</span> <span class="nf">testTODO</span><span class="p">(</span><span class="n">email</span><span class="p">:</span><span class="n">String</span><span class="p">,</span> <span class="n">subject</span><span class="p">:</span><span class="n">String</span><span class="p">,</span> <span class="n">content</span><span class="p">:</span><span class="n">String</span> <span class="p">):</span><span class="n">Pair</span><span class="p">&lt;</span><span class="n">Int</span><span class="p">,</span><span class="n">String</span><span class="p">&gt;</span> <span class="p">{</span>
  
      <span class="k">return</span> <span class="k">if</span><span class="p">(</span><span class="n">email</span><span class="p">.</span><span class="n">isNullOrEmpty</span><span class="p">()){</span>
          <span class="n">TODO</span><span class="p">(</span><span class="s">"figure out error handling/logging here"</span><span class="p">)</span>
      <span class="p">}</span>
      <span class="k">else</span> <span class="p">{</span>
          <span class="c1">// send email
</span>          <span class="n">Pair</span><span class="p">(</span><span class="m">200</span><span class="p">,</span> <span class="s">"success"</span><span class="p">)</span>
      <span class="p">}</span>
  <span class="p">}</span>
...
<h2 id="kotlin-member-reference">Member Reference</h2>
<p>Reference a property of a class just like you can reference a method</p>
<div class="highlighter-rouge"><pre class="highlight"><code>
  <span class="k">import</span> <span class="nn">kotlin.reflect.KProperty</span>

  <span class="kd">data class</span> <span class="nc">Employee</span><span class="p">(</span><span class="kd">val</span> <span class="py">id</span><span class="p">:</span><span class="n">Int</span><span class="p">,</span> <span class="kd">val</span> <span class="py">email</span><span class="p">:</span><span class="n">String</span><span class="p">)</span>
  
  
  <span class="k">fun</span> <span class="nf">printMember</span><span class="p">(</span><span class="n">prop</span><span class="p">:</span> <span class="n">KProperty</span><span class="p">&lt;*&gt;):</span><span class="n">Unit</span> <span class="p">=</span> <span class="n">println</span><span class="p">(</span><span class="n">prop</span><span class="p">.</span><span class="n">name</span><span class="p">)</span>
  
  
  <span class="c1">// You can reference the properties of Employee class using "::"
</span>  <span class="c1">// This facilitates type-safe meta programming. E.g. you can use
</span>  <span class="c1">// this approach for mapping properties to a table, or building
</span>  <span class="c1">// queries in an ORM. 
</span>  <span class="k">fun</span> <span class="nf">testMemberReference</span><span class="p">():</span><span class="n">Unit</span> <span class="p">{</span>
      <span class="n">printMember</span><span class="p">(</span> <span class="n">Employee</span><span class="o">::</span><span class="n">id</span>    <span class="p">)</span>
      <span class="n">printMember</span><span class="p">(</span> <span class="n">Employee</span><span class="o">::</span><span class="n">email</span> <span class="p">)</span>
  <span class="p">}</span>
...
<h2 id="kotlin-annotations">Annotations</h2>
<p>Annotations are available and can be applied to classes, methods, parameters and more</p>
<div class="highlighter-rouge"><pre class="highlight"><code>
  <span class="n">@Target</span><span class="p">(</span><span class="n">AnnotationTarget</span><span class="p">.</span><span class="n">CLASS</span><span class="p">)</span>
  <span class="k">annotation</span> <span class="kd">class</span> <span class="nc">Api</span> <span class="p">(</span><span class="kd">val</span> <span class="py">name</span>     <span class="p">:</span> <span class="n">String</span> <span class="p">=</span> <span class="s">""</span><span class="p">,</span>
                        <span class="kd">val</span> <span class="py">desc</span>     <span class="p">:</span> <span class="n">String</span> <span class="p">=</span> <span class="s">""</span><span class="p">)</span>
  
  					  
  <span class="n">@Target</span><span class="p">(</span><span class="n">AnnotationTarget</span><span class="p">.</span><span class="n">FUNCTION</span><span class="p">)</span>
  <span class="k">annotation</span> <span class="kd">class</span> <span class="nc">Get</span><span class="p">(</span>
          <span class="kd">val</span> <span class="py">path</span>     <span class="p">:</span> <span class="n">String</span> <span class="p">=</span> <span class="s">""</span>
  <span class="p">)</span>
  
  
  <span class="n">@Target</span><span class="p">(</span><span class="n">AnnotationTarget</span><span class="p">.</span><span class="n">VALUE_PARAMETER</span><span class="p">)</span>
  <span class="k">annotation</span> <span class="kd">class</span> <span class="nc">Arg</span><span class="p">(</span><span class="kd">val</span> <span class="py">desc</span><span class="p">:</span><span class="n">String</span><span class="p">)</span>
  
  
  <span class="kd">data class</span> <span class="nc">Movie</span><span class="p">(</span><span class="kd">val</span> <span class="py">name</span><span class="p">:</span><span class="n">String</span><span class="p">,</span> <span class="kd">val</span> <span class="py">year</span><span class="p">:</span><span class="n">Int</span><span class="p">)</span>
  
  
  <span class="c1">// Use Api annotation on the class to designate a Web API 
</span>  <span class="n">@Api</span><span class="p">(</span><span class="s">"/movies"</span><span class="p">,</span> <span class="n">desc</span> <span class="p">=</span> <span class="s">"api to get movie info"</span><span class="p">)</span>
  <span class="kd">class</span> <span class="nc">MovieApi</span> <span class="p">{</span>
  
      <span class="c1">// Use Get annotation on a method to designate an http get request
</span>      <span class="c1">// Use the Arg annotation on a parameter to describe parameter
</span>      <span class="n">@Get</span><span class="p">(</span><span class="s">"blockbusters"</span><span class="p">)</span>
      <span class="k">fun</span> <span class="nf">blockbusters</span><span class="p">(</span><span class="n">@Arg</span><span class="p">(</span><span class="s">"year released"</span><span class="p">)</span>
                       <span class="n">year</span><span class="p">:</span><span class="n">Int</span><span class="p">):</span> <span class="n">List</span><span class="p">&lt;</span><span class="n">Movie</span><span class="p">&gt;</span> <span class="p">{</span>
        <span class="k">return</span> <span class="n">listOf</span><span class="p">(</span>
                <span class="n">Movie</span><span class="p">(</span><span class="s">"Wonder Woman"</span><span class="p">,</span> <span class="m">2017</span><span class="p">),</span>
                <span class="n">Movie</span><span class="p">(</span><span class="s">"Spider-Man"</span>  <span class="p">,</span> <span class="m">2017</span><span class="p">)</span>
        <span class="p">)</span>
    <span class="p">}</span>
  <span class="p">}</span>
...
<h2 id="kotlin-deprecation">Deprecation</h2>
<p>Use the <strong>@Deprecated</strong> annotation mark deprecated code with 
varying levels</p>
<div class="highlighter-rouge"><pre class="highlight"><code>
  <span class="n">@Deprecated</span><span class="p">(</span><span class="s">"deprecation warning"</span><span class="p">,</span> <span class="n">level</span> <span class="p">=</span> <span class="n">DeprecationLevel</span><span class="p">.</span><span class="n">WARNING</span><span class="p">)</span>
  <span class="k">fun</span> <span class="nf">sampleFunc1</span><span class="p">():</span><span class="n">Unit</span> <span class="p">{</span>
  <span class="p">}</span>
  
  
  <span class="n">@Deprecated</span><span class="p">(</span><span class="s">"deprecation hidden"</span><span class="p">,</span> <span class="n">level</span> <span class="p">=</span> <span class="n">DeprecationLevel</span><span class="p">.</span><span class="n">HIDDEN</span><span class="p">)</span>
  <span class="k">fun</span> <span class="nf">sampleFunc2</span><span class="p">():</span><span class="n">Unit</span> <span class="p">{</span>
  <span class="p">}</span>
  
  
  <span class="n">@Deprecated</span><span class="p">(</span><span class="s">"deprecation error"</span><span class="p">,</span> <span class="n">level</span> <span class="p">=</span> <span class="n">DeprecationLevel</span><span class="p">.</span><span class="n">ERROR</span><span class="p">)</span>
  <span class="k">fun</span> <span class="nf">sampleFunc3</span><span class="p">():</span><span class="n">Unit</span> <span class="p">{</span>
  <span class="p">}</span>
  
  
  <span class="k">fun</span> <span class="nf">testDeprecation</span><span class="p">():</span><span class="n">Unit</span> <span class="p">{</span>
      <span class="c1">// deprecations with level warning are shown with strike-through
</span>      <span class="n">sampleFunc1</span><span class="p">()</span>
      
      <span class="c1">// deprecations with level hidden are not available / resolved
</span>      <span class="c1">// so the following usage is a compile error 
</span>      <span class="n">sampleFunc2</span><span class="p">()</span>
      
      <span class="c1">// deprecation with level error is a compile level deprecation error
</span>      <span class="n">sampleFunc3</span><span class="p">()</span>
  <span class="p">}</span>
</code></pre>
</div>
<a href="#overview" class="more"><span class="btn btn-template">Back to top</span></a> <br/><br/>
